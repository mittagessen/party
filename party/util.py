...
def checkpoint_to_kraken(checkpoint_path: Union[str, 'PathLike'],
    ...
    config = {"prompt_mode": state_dict['datamodule_hyper_parameters']['prompt_mode'],
              ...
              "decoder_num_layers": hyper_params.get('decoder_num_layers', 18),
              "decoder_num_heads": hyper_params.get('decoder_num_heads', 9),
              "decoder_num_kv_heads": hyper_params.get('decoder_num_kv_heads', 3),
              "decoder_embed_dim": hyper_params.get('decoder_embed_dim', 288),
              "decoder_max_seq_len": 384,
              "decoder_intermediate_dim": hyper_params.get('decoder_intermediate_dim', 768),
