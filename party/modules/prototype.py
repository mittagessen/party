...
class PrototypeHead(nn.Module):
    ...
    Prototypes share the underlying parameter table with the decoder token
    embedding via :meth:`tie_embeddings`. The temperature is a learnable
    scalar, clamped at use time to keep logits in a numerically sane range.
    """
    def __init__(self,
                 embed_dim: int,
                 vocab_size: int,
